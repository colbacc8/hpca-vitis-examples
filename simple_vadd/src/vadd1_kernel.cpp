...
static void store_res(uint32_t* out, hls::stream<uint32_t>& out_stream, int size) {
    for (int i = 0; i < size; i++) {
...
void vadd1_kernel(uint32_t* in1, uint32_t* in2, uint32_t* out, int size) {
